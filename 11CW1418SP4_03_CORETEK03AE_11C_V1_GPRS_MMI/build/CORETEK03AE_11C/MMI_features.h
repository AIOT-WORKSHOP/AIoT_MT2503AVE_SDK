...
#if (!defined(__MMI_BTBOX_NOLCD__) && !defined(__IOT__) && !defined(__IOT_LOCK__) && !defined(__AIOT_ECU__))
...
#if (!defined(__UNIFIED_MESSAGE_LOW_MEMORY_SUPPORT__) && (defined(__PLUTO_MMI_PACKAGE__)  || !defined(LOW_COST_SUPPORT)))|| defined(__IOT_LOCK__) || defined(__AIOT_ECU__)
